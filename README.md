...
- 📊 Цветная иконка в системном трее:
  ...
  - 🟤 **Темно-желтая** - ручной режим "Всегда не засыпать"
...
Установите [.NET 8.0 SDK](https://dotnet.microsoft.com/download/dotnet/8.0), затем откройте PowerShell в папке проекта.
...
3. **При изменении статуса**:
   ...
   - Меняет иконку в зависимости от режима:
     ...
     - 🟤 Темно-желтая - ручной "Всегда не засыпать"
